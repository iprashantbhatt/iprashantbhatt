...
**🟠 [House of Bitcoin](https://houseofbitcoin.app)**
Real-time Bitcoin intelligence dashboard — live BTC price, halving countdown, Fear & Greed index, on-chain metrics, top 100 coins & news.
`React 18` `Node.js`

</td>
<td width="50%" valign="top">

**🔍 [ResearchBot](https://github.com/iprashantbhatt/researchagent)**
Autonomous multi-agent NSE/BSE research system — News + Filings agents, a Verifier, and a Telegram-notifying daily routine, all orchestrated by a Manager Bot.
